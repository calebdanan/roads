    ...
    speak: function() {
        if (Math.random() < .005) {
          ...
          if(!ig.game.getEntityByName(bubbleName)) {
            var parameters = {text: 'The angles of the bounces will help reach enemies from a distance.', tracks: this.name, margin: 0, lifeSpan: 4, shape: 'square', name: bubbleName, color:[255,255,255]};
